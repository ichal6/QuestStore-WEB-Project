        ...
        <aside>
            <div class="nav">
                <ul class="nav-menu">
                    ...
                    <li><a href="admins_list.jspl"><img src="../assets/icons/admins_icon.png" alt="admin-icon">Admins</a></li>
                    <li id="select-page"><a href="mentors_list.jsp"><img src="../assets/icons/mentors_icon.png" alt="mentors-icon">Mentors</a></li>
