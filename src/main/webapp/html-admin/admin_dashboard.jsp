        ...
        <aside>
            <div class="nav">
                <ul class="nav-menu">
                    ...
                    <li><a href="codecoolers_list.html"><img src="../assets/icons/codecoolers_icon.png" alt="codecoolers-icon">Codecoolers</a></li>
                    <li><a href="classes_list.html"><img src="../assets/icons/classes_icon.png" alt="classes-icon">Classes</a></li>
                    <li><a href="teams_list.html"><img src="../assets/icons/teams_icon.png" alt="teams-icon">Teams</a></li>
                    <li><a href="quests_list.html"><img src="../assets/icons/quests_icon.png" alt="quests-icon">Quests</a></li>
                    <li><a href="artifacts_list.html"><img src="../assets/icons/artifacts_icon.png" alt="artifacts-icon">Artifacts</a></li>
                </ul>
            </div>
        </aside>
        <div class="options_container">
            <div class="options_rectangle">
                ...
                <div class="lower_section">
                    <p><a href="admins_list.html">See list of admins...</a></p>
                </div>
            </div>
            <div class="options_rectangle">
                <div class="upper_section">
                ...
                <div class="lower_section">
                    <p><a href="mentors_list.html">See list of mentors...</a></p>
                </div>
            </div>
            <div class="options_rectangle">
                <div class="upper_section">
                ...
                <div class="lower_section">
                    <p><a href="codecoolers_list.html">See list of Codecoolers...</a></p>
                </div>
            </div>
            <div class="options_rectangle">
                <div class="upper_section">
                ...
                <div class="lower_section">
                    <p><a href="levels_list.html">See list of all levels...</a></p>
                </div>
            </div>
            <div class="options_rectangle">
                <div class="upper_section">
                ...
                <div class="lower_section">
                    <p><a href="classes_list.html">See list of classes...</a></p>
                </div>
            </div>
            <div class="options_rectangle">
                <div class="upper_section">
                ...
                <div class="lower_section">
                    <p><a href="teams_list.html">See list of teams...</a></p>
                </div>
            </div>
            <div class="options_rectangle">
                <div class="upper_section">
                ...
                <div class="lower_section">
                    <p><a href="quests_list.html">See list of quests...</a></p>
                </div>
            </div>
            <div class="options_rectangle">
                <div class="upper_section">
                ...
                <div class="lower_section">
                    <p><a href="artifacts_list.html">See list of artifacts...</a></p>
                </div>
            </div>
        </div>
    </div>
