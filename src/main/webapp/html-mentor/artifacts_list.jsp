    ...
    <div class="container">
        <aside>
            <div class="nav">
                <ul class="nav-menu">
                    ...
                    <li><a href="quests_list.jsp"><img src="../assets/icons/quests_icon.png" alt="artifacts-icon">Quests</a></li>
        ...
        <div class="all-artifacts-container">
            <div class="upper-section">
                <div class="h1-button">
                    <h1>All artifacts</h1>
                    <button onclick="location.href='artifacts_add_new.jsp'" type="button" class="btn">+ Add new artifact</button>
                </div>
