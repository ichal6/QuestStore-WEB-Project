        ...
        <aside>
            <div class="nav">
                <ul class="nav-menu">
                    ...
                    <li id="select-page"><a href="codecoolers_list.jsp"><img
                                src="../assets/icons/codecoolers_icon.png" alt="codecoolers-icon">Codecoolers</a></li>
        ...
        <div class="details-container">
            ...
            <div class="personal-details">
                ...
                <div class="add-new-achivement">
                    ...
                    <select class="achivement add-achievement">
                        <option> MartaMariuszMichał Tictactoe</option>
                        <option> BrakNazwy Team</option>
                    </select>
                    <div class="button-position"> <button class="btn" id="add-team">Add new</button></div>
                </div>
            </div>
            <div class="personal-details">
