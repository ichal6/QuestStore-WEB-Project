    ...
    <div class="container">
        ...
        <div class="details-container"> 
            ...
            <div class="personal-details">
                <h2>Basic details</h2>
                    <div class ="details">                      
                        <div class="class"> Name*: <input type="text" id="class-name"></div>
                        <div class="class"> City: <input type="text" id="class-city"></div>
                        <div class="class"> Start date*: <input type="text" id="class-start-date"></div>
                        <div class="class"> End date*: <input type="text" id="class-end-date"></div>
                        <div class="lower-section">
                            <p>*- Fields marked like these need to be filled to add new class</p>
